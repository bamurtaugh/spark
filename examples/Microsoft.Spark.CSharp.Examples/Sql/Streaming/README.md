...
In these streaming samples, you'll see how to use [.NET for Apache Spark](https://dotnet.microsoft.com/apps/data/spark) 
to analyze incoming data. In the world of big data, this is known as **stream processing**.
